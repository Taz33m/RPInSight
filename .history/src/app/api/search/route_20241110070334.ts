  ...
  try {
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: `You are an RPI campus expert. Respond with both the building name and a brief description relevant to the query. Format your response as JSON with 'buildingName' and 'description' fields. If the query mentions "nearby" or similar terms, prioritize locations close to the user. Stick to these buildings on the RPI campus: Folsom Library, Russell Sage Dining Hall, Student Union, Greene Building, Walker Laboratory, Academy Hall, DCC (Darrin Communications Center).`
        },
        {
          role: "user",
